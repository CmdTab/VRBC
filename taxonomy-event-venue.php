...
<div class="page-container group">
		<div id="primary" class="primary two-third first event-archive">
	...
	<header class="venue-header">
		...
		<h1 class="entry-title"><?php printf( __( 'Events at: %s', 'eventorganiser' ), '<span>' .eo_get_venue_name($venue_id). '</span>' );?></h1>
